...
* ![aiogram 3](https://img.shields.io/badge/3.*-aiogram-blue) as a main library
...
* ![aiogram-dialog](https://img.shields.io/badge/2.2.0-aiogram__dialog-green) (Optional) for creating multi-step
  dialogs
